  ...
  <div class="pic">
    ...
    <div class="rounded container news">
      <div class="container first">
        <div class="container col-sm-4 offset-sm-8 row align-items-end second">
          <div>
...
<div id="lissez" class="container rounded">
  ...
  <div class="container second">
    ...
    <div class="row align-items-start rounded whole" >
      ...
      <div class="container col-sm-9 news">
        ...
        <div class="container-fluid row second align-self-center">
          <div class="col-11">
            <p><?=  strip_tags(htmlspecialchars_decode($post->getShortContent(69))) ?></p>
          </div>
          <div class="col-1 row align-items-center">
            <a class="bg-primary" href="<?= HOST ?>post/id/<?= $post->getId() ?>">
              <p id="go">></p>
            </a>
          </div>
        </div>
...
<div id="showPosts" class="container col-8">
